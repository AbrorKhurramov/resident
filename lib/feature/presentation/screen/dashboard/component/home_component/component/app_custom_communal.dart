...
class AppCustomCommunal extends StatefulWidget {
  final int type;
  final BasePaginationListResponse<Counter> counter;
  final String apartmentId;

  const AppCustomCommunal({
    Key? key,
    required this.type,
  ...
  @override
  State<AppCustomCommunal> createState() => _AppCustomCommunalState();
}

class _AppCustomCommunalState extends State<AppCustomCommunal> {
