            ...
            child: SvgPicture.asset('assets/icons/no_internet.svg'),
                 ...
                 Center(
                   child: Padding(
                     ...
                     child: Text(_appLocalization.no_internet_connection.capitalize(),style: Theme.of(context).textTheme.headline1!.copyWith(fontSize: 18.sf(context),color: Colors.white),textAlign: TextAlign.center,),
                   ),
                 ),
                 ...
                 Center(
                   child: Padding(
                       ...
                       child: Text(_appLocalization.check_your_internet.capitalize(),style: Theme.of(context).textTheme.headline3!.copyWith(fontSize: 15.sf(context),color: Colors.white),maxLines: 2,textAlign:TextAlign.center,)),
                 ),
                const Spacer(),
                       Padding(
                  ...
                  child: ElevatedButton(
                      ...
                      child: Text(_appLocalization.try_again.capitalize(),style: Theme.of(context).textTheme.headline2!.copyWith(fontSize: 14.sf(context),color: Colors.white),)),
                ),
                 AppDimension.verticalSize_32,
               ],
              ),
